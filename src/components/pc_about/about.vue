    ...
    <div class="about-us">
        ...
        <div class="about-boxes" ref="zoomBackground"  :style="{ height: '75vw' }">
          <Transition name="fade">
            ...
            <div id="aboutuscontent" v-if="show">
              ...
              <div class="article">
                  <div class="text">Infini Capital is a global, multi-strategy investment firm with a Pan-Asia focus. Built on a foundation of proprietary trading, we aim to deliver high-quality, risk-adjusted returns through diversified, low-correlation, high-Sharpe strategies. </div>
              </div>
              <div>
        ...
        <!-- <div class="feature-boxes">
            ...
            <div class="features">
                ...
                <a href="https://www.adgm.com/media/announcements/infini-capital-establishes-a-strategic-presence-in-emea-region-with-abu-dhabi-office" target="_blank"><div class="feature">Asian Hedge Fund with Presence in Abu Dhabi</div></a>
